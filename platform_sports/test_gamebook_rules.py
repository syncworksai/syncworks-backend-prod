...
class GameBookRulesTests(APITestCase):
    def setUp(self):
        ...
        self.game = SportsGame.objects.create(team=self.team, opponent_name="Opponent", start_at=timezone.now(), created_by=self.manager, home_run_rule=SportsGame.HomeRunRule.FIXED, home_run_limit=1)
    ...
    def test_fixed_home_run_limit_is_enforced(self):
        ...
        self.assertEqual(second.data["code"], "HR_LIMIT")
