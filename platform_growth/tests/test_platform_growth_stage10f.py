...
class TestPlatformGrowthStage10F(TestCase):
    ...
    def test_god_mode_can_queue_draft(self):
        ...
        res = self.client.post(f"/api/v1/platform-growth/growth/drafts/{self.draft.id}/queue/", {}, format="json")
    ...
    def test_queue_with_missing_channel_returns_400(self):
        self.client.force_authenticate(user=self.god)
        res = self.client.post(f"/api/v1/platform-growth/growth/drafts/{self.draft.id}/queue/", {"channel_connection": 999999}, format="json")
    ...
    def test_simulate_post_marks_item_posted(self):
        ...
        res = self.client.post(f"/api/v1/platform-growth/growth/queue/{queue_item.id}/simulate-post/", {}, format="json")
