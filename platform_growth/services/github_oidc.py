...
AUDIENCE = "syncworks-growth-runtime"
EXPECTED_REPOSITORY = "syncworksai/syncworks-backend-prod"
EXPECTED_REF = "refs/heads/main"
EXPECTED_WORKFLOW_REF = f"{EXPECTED_REPOSITORY}/.github/workflows/growth-runtime.yml@{EXPECTED_REF}"
...
def verify_growth_runtime_token(token: str) -> dict:
    if not token:
    ...
    if claims.get("ref") != EXPECTED_REF:
        raise GitHubOIDCError("Growth runtime may only run from main.")
